...
class DeviceList:
    ...
    device_list : PyStageLinQDataClasses.StageLinQDiscoveryData
    ...
    def find_registered_device(self, discovery_frame) -> PyStageLinQDataClasses.StageLinQDiscoveryData:
    ...
    def find_main_interface(self, discovery_frame) -> PyStageLinQDataClasses.StageLinQDiscoveryData:
        for device in self.device_list:
